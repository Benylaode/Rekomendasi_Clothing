...
for col in ['Division Name', 'Department Name', 'Class Name', 'Title']:
...
"""kode di atas menunjukan nilai dari hasil nDCG@5 populer dan tertentu yang menujukan bahwa model sudah bisa memberikan rekomendasi yang relevan karena kedunya mendekati 1"""